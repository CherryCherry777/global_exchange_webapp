...
DEFAULT_DENOMINATIONS = {
    "PYG": {
        "bills": [10000, 5000, 2000, 1000, 500, 100],
        "coins": [50, 10, 5, 1]
    },
    "USD": {
...
def setup_database(sender, **kwargs):
    ...
    # ---------------------------------------------------------------
    # SETUP DE ROLES POR DEFECTO Y USUARIOS POR DEFECTO
    # ---------------------------------------------------------------
    ...
    # ---------------------------------------------------------------
    # SETUP DE CATEGORIAS DE CLIENTE Y CLIENTES
    # ---------------------------------------------------------------
    ...
    # ---------------------------------------------------------------
    # SETUP DE ENTIDADES BANCARIAS Y TELEFONICAS
    # MONEDAS, COTIZACIONES Y DENOMINACIONES
    # ---------------------------------------------------------------    

...
class CompraVentaTests(TestCase):
    ...
    def test_compraventa_billetera_con_pin(self):
        ...
        with patch('webapp.views.compraventa_y_conversión.cobrar_al_cliente_billetera') as mock_cobrar:
            ...
            # Debe mostrar formulario de PIN
            self.assertEqual(response.status_code, 200)
            self.assertTemplateUsed(response, 'webapp/compraventa_y_conversion/ingresar_pin.html')
    ...
    def test_compraventa_cancelar_pago_billetera(self):
        ...
        # Verificar redirección después de cancelar
        self.assertEqual(response.status_code, 302)
    ...
    def test_api_active_currencies_aplicar_descuento_categoria(self):
        ...
        # Con descuento del 5%, los valores deberían ser diferentes a los base
        self.assertIsNotNone(pyg_data)
        self.assertEqual(pyg_data['venta'], 1.0)  # PYG siempre es 1.0
        self.assertEqual(pyg_data['compra'], 1.0)  # PYG siempre es 1.0
    ...
    def test_compraventa_crear_transaccion_exitosa(self):
        ...
        # Crear tipos de pago y cobro básicos para la prueba
